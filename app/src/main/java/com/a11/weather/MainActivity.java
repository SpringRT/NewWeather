...
public class MainActivity extends AppCompatActivity {
    ...
    private Weather currentWeather = MyApplication.currentWeather;
    private boolean screenIsSet = MyApplication.screenIsSet;
    ...
    private void setScreen(Weather weather){
        if (weather != null ){
            MyApplication.screenIsSet = true;
            screenIsSet = true;
            MyApplication.currentWeather = weather;
